        ...
        <LayoutContent>
          ...
          >
            <Flex direction="column" alignItems="stretch" gap={6}>
              ...
              <Button type="github">
                {formatMessage({ id: 'Auth.form.button.auth', defaultMessage: 'Github' })}
              </Button>
              <Button type="google">
                {formatMessage({ id: 'Auth.form.button.auth', defaultMessage: 'Google' })}
              </Button>
              <Button type="google">
                {formatMessage({ id: 'Auth.form.button.auth', defaultMessage: 'Facebook' })}
              </Button>
